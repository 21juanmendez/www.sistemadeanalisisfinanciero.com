        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2024 <a href="<?php echo $URL ?>">ANF115-GRUPO#8</a>.</strong> Todos los derechos reservados.
        </footer>
    </div>
    <!-- ./wrapper -->
    ...
    <!-- ChartJS -->
    <script src="<?php echo $URL ?>/public/templates/plugins/chart.js/Chart.min.js"></script>
    <!--bootstrap 5-->
